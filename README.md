...
1. Añade y verifica la propiedad `https://ingelap.com.co` en Google Search Console (verificación por DNS o archivo HTML).
2. En Search Console → Sitemaps → envía `https://ingelap.com.co/sitemap.xml`.
3. Usa “URL Inspection” → “Request Indexing” para páginas nuevas.

Comprobaciones rápidas

```bash
curl -I https://ingelap.com.co
